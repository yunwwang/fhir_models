...
class PathTest < Test::Unit::TestCase
  ...
  def test_path_without_type
    result = FHIRPath.evaluate('name.given', PATIENT)
  ...
  def test_parent
    ...
    data = {}
    parent = { 'type' => 'integer' }
    result = FHIRPath.evaluate(expression, data, parent)
