module FHIR
  class UsageContext < FHIR::Model
    ...
    METADATA = {
      ...
      'valueCodeableConcept' => {'valid_codes'=>{nil=>[], 'http://snomed.info/sct'=>[], 'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[], 'http://nucc.org/provider-taxonomy'=>[]}, 'type'=>'CodeableConcept', 'path'=>'UsageContext.value[x]', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
