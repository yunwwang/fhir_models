module FHIR
  class Count < FHIR::Model
    ...
    METADATA = {
      ...
      'comparator' => {'type'=>'code', 'path'=>'Count.comparator', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/quantity-comparator|4.0.0', 'uri'=>nil}},
