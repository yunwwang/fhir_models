  ...
  class SpecimenDefinition < FHIR::Model
    ...
    class TypeTested < FHIR::Model
      ...
      METADATA = {
        ...
        'preference' => {'type'=>'code', 'path'=>'TypeTested.preference', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-contained-preference|4.0.0'}},
