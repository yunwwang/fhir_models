module FHIR
  class Endpoint < FHIR::Model
    ...
    METADATA = {
      ...
      'payloadMimeType' => {'valid_codes'=>{'urn:ietf:bcp:13'=>[]}, 'type'=>'code', 'path'=>'Endpoint.payloadMimeType', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/mimetypes|4.0.0'}},
