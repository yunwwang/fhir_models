module FHIR
  class CoverageEligibilityRequest < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'CoverageEligibilityRequest.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'status' => {'type'=>'code', 'path'=>'CoverageEligibilityRequest.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/fm-status|4.0.0', 'uri'=>nil}},
      'priority' => {'type'=>'CodeableConcept', 'path'=>'CoverageEligibilityRequest.priority', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/process-priority', 'uri'=>nil}},
      'purpose' => {'type'=>'code', 'path'=>'CoverageEligibilityRequest.purpose', 'min'=>1, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/eligibilityrequest-purpose|4.0.0', 'uri'=>nil}},
    ...
    class Item < FHIR::Model
      ...
      class Diagnosis < FHIR::Model
        ...
        METADATA = {
          ...
          'diagnosisCodeableConcept' => {'type'=>'CodeableConcept', 'path'=>'Diagnosis.diagnosis[x]', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/icd-10', 'uri'=>nil}},
