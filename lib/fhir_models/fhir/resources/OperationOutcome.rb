  ...
  class OperationOutcome < FHIR::Model
    ...
    class Issue < FHIR::Model
      ...
      METADATA = {
        ...
        'severity' => {'type'=>'code', 'path'=>'Issue.severity', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/issue-severity|4.0.0'}},
        'code' => {'type'=>'code', 'path'=>'Issue.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/issue-type|4.0.0'}},
