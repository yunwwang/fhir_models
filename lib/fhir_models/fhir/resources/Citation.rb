module FHIR
  class Citation < FHIR::Model
    ...
    METADATA = {
      ...
      'summary' => {'type'=>'ContactDetail', 'path'=>'Citation.summary', 'min'=>0, 'max'=>Float::INFINITY},
      'summary.style' => {'type'=>'CodeableConcept', 'path'=>'Citation.summary.style', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/citation-summary-style'}},
      'summary.text' => {'type'=>'markdown', 'path'=>'Citation.summary.text', 'min'=>1, 'max'=>1},
    ...
    attr_accessor :summary           # 0-* [ ContactDetail ]
    attr_accessor :summary.style     # 0-1 CodeableConcept
    attr_accessor :summary.text      # 1-1 markdown
