  ...
  class ExampleScenario < FHIR::Model
    ...
    class Actor < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/examplescenario-actor-type'=>['person', 'entity']}, 'type'=>'code', 'path'=>'Actor.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/examplescenario-actor-type|4.0.0'}},
