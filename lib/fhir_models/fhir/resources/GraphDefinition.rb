module FHIR
  class GraphDefinition < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'GraphDefinition.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'status' => {'type'=>'code', 'path'=>'GraphDefinition.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0', 'uri'=>nil}},
      ...
      'jurisdiction' => {'type'=>'CodeableConcept', 'path'=>'GraphDefinition.jurisdiction', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'valueSet'=>'http://hl7.org/fhir/ValueSet/jurisdiction', 'uri'=>nil}},
      'purpose' => {'type'=>'markdown', 'path'=>'GraphDefinition.purpose', 'min'=>0, 'max'=>1},
      'start' => {'type'=>'code', 'path'=>'GraphDefinition.start', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/resource-types|4.0.0', 'uri'=>nil}},
    ...
    class Link < FHIR::Model
      ...
      class Target < FHIR::Model
        ...
        METADATA = {
          ...
          'type' => {'type'=>'code', 'path'=>'Target.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/resource-types|4.0.0', 'uri'=>nil}},
        ...
        class Compartment < FHIR::Model
          ...
          METADATA = {
            ...
            'use' => {'type'=>'code', 'path'=>'Compartment.use', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/graph-compartment-use|4.0.0', 'uri'=>nil}},
            'code' => {'type'=>'code', 'path'=>'Compartment.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/compartment-type|4.0.0', 'uri'=>nil}},
            'rule' => {'type'=>'code', 'path'=>'Compartment.rule', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/graph-compartment-rule|4.0.0', 'uri'=>nil}},
