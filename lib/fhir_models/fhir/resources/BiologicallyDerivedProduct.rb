module FHIR
  class BiologicallyDerivedProduct < FHIR::Model
    ...
    METADATA = {
      ...
      'productCategory' => {'type'=>'code', 'path'=>'BiologicallyDerivedProduct.productCategory', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-category|4.0.0'}},
      ...
      'status' => {'type'=>'code', 'path'=>'BiologicallyDerivedProduct.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-status|4.0.0'}},
    ...
    class Storage < FHIR::Model
      ...
      METADATA = {
        ...
        'scale' => {'type'=>'code', 'path'=>'Storage.scale', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-storage-scale|4.0.0'}},
