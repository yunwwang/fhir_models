module FHIR
  class CatalogEntry < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'CatalogEntry.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0'}},
    ...
    class RelatedEntry < FHIR::Model
      ...
      METADATA = {
        ...
        'relationtype' => {'type'=>'code', 'path'=>'RelatedEntry.relationtype', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/relation-type|4.0.0'}},
