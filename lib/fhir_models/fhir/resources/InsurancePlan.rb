module FHIR
  class InsurancePlan < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'InsurancePlan.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'status' => {'type'=>'code', 'path'=>'InsurancePlan.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0', 'uri'=>nil}},
      'type' => {'type'=>'CodeableConcept', 'path'=>'InsurancePlan.type', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/insuranceplan-type', 'uri'=>nil}},
    ...
    class Contact < FHIR::Model
      ...
      METADATA = {
        ...
        'purpose' => {'type'=>'CodeableConcept', 'path'=>'Contact.purpose', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'valueSet'=>'http://hl7.org/fhir/ValueSet/contactentity-type', 'uri'=>nil}},
        ...
        class Benefit < FHIR::Model
          ...
          class Cost < FHIR::Model
            ...
            METADATA = {
              ...
              'applicability' => {'type'=>'CodeableConcept', 'path'=>'Cost.applicability', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/insuranceplan-applicability|4.0.0', 'uri'=>nil}},
