module FHIR
  class TestReport < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'TestReport.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-status-codes|4.0.0'}},
      ...
      'result' => {'type'=>'code', 'path'=>'TestReport.result', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-result-codes|4.0.0'}},
    ...
    class Participant < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Participant.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-participant-type|4.0.0'}},
      ...
      class Action < FHIR::Model
        ...
        class Operation < FHIR::Model
          ...
          METADATA = {
            ...
            'result' => {'type'=>'code', 'path'=>'Operation.result', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-action-result-codes|4.0.0'}},
        ...
        class Assert < FHIR::Model
          ...
          METADATA = {
            ...
            'result' => {'type'=>'code', 'path'=>'Assert.result', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-action-result-codes|4.0.0'}},
