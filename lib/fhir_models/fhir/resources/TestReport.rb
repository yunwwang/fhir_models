  ...
  class TestReport < FHIR::Model
    ...
    class Participant < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/report-participant-type'=>['test-engine', 'client', 'server']}, 'type'=>'code', 'path'=>'Participant.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-participant-type|4.0.0'}},
      ...
      class Action < FHIR::Model
        ...
        class Operation < FHIR::Model
          ...
          METADATA = {
            ...
            'result' => {'valid_codes'=>{'http://hl7.org/fhir/report-action-result-codes'=>['pass', 'skip', 'fail', 'warning', 'error']}, 'type'=>'code', 'path'=>'Operation.result', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/report-action-result-codes|4.0.0'}},
