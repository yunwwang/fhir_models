  ...
  class EffectEvidenceSynthesis < FHIR::Model
    ...
    class ResultsByExposure < FHIR::Model
      ...
      METADATA = {
        ...
        'exposureState' => {'valid_codes'=>{'http://hl7.org/fhir/exposure-state'=>['exposure', 'exposure-alternative']}, 'type'=>'code', 'path'=>'ResultsByExposure.exposureState', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/exposure-state|4.0.0'}},
