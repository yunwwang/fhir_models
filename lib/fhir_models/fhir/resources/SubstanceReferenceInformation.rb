module FHIR
  class SubstanceReferenceInformation < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'SubstanceReferenceInformation.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
