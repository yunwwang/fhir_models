module FHIR
  class MolecularSequence < FHIR::Model
    ...
    METADATA = {
      ...
      'type' => {'valid_codes'=>{'http://hl7.org/fhir/sequence-type'=>['aa', 'dna', 'rna']}, 'type'=>'code', 'path'=>'MolecularSequence.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/sequence-type|4.0.0'}},
    ...
    class Quality < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/quality-type'=>['indel', 'snp', 'unknown']}, 'type'=>'code', 'path'=>'Quality.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/quality-type|4.0.0'}},
    ...
    class Repository < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/repository-type'=>['directlink', 'openapi', 'login', 'oauth', 'other']}, 'type'=>'code', 'path'=>'Repository.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/repository-type|4.0.0'}},
    ...
    class StructureVariant < FHIR::Model
      ...
      METADATA = {
        ...
        'variantType' => {'type'=>'CodeableConcept', 'path'=>'StructureVariant.variantType', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://loinc.org/vs/LL379-9|4.0.0'}},
