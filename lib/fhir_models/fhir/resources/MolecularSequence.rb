module FHIR
  class MolecularSequence < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'MolecularSequence.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'type' => {'type'=>'code', 'path'=>'MolecularSequence.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/sequence-type|4.0.0', 'uri'=>nil}},
    ...
    class ReferenceSeq < FHIR::Model
      ...
      METADATA = {
        ...
        'chromosome' => {'type'=>'CodeableConcept', 'path'=>'ReferenceSeq.chromosome', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/chromosome-human', 'uri'=>nil}},
        'genomeBuild' => {'type'=>'string', 'path'=>'ReferenceSeq.genomeBuild', 'min'=>0, 'max'=>1},
        'orientation' => {'type'=>'code', 'path'=>'ReferenceSeq.orientation', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/orientation-type|4.0.0', 'uri'=>nil}},
        'referenceSeqId' => {'type'=>'CodeableConcept', 'path'=>'ReferenceSeq.referenceSeqId', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/sequence-referenceSeq', 'uri'=>nil}},
        ...
        'strand' => {'type'=>'code', 'path'=>'ReferenceSeq.strand', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/strand-type|4.0.0', 'uri'=>nil}},
    ...
    class Quality < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Quality.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/quality-type|4.0.0', 'uri'=>nil}},
        'standardSequence' => {'type'=>'CodeableConcept', 'path'=>'Quality.standardSequence', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/sequence-quality-standardSequence', 'uri'=>nil}},
        ...
        'method' => {'local_name'=>'local_method', 'type'=>'CodeableConcept', 'path'=>'Quality.method', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/sequence-quality-method', 'uri'=>nil}},
    ...
    class Repository < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Repository.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/repository-type|4.0.0', 'uri'=>nil}},
    ...
    class StructureVariant < FHIR::Model
      ...
      METADATA = {
        ...
        'variantType' => {'type'=>'CodeableConcept', 'path'=>'StructureVariant.variantType', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://loinc.org/vs/LL379-9|4.0.0', 'uri'=>nil}},
