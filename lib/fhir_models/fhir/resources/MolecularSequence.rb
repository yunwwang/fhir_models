module FHIR
  class MolecularSequence < FHIR::Model
    ...
    METADATA = {
      ...
      'type' => {'type'=>'code', 'path'=>'MolecularSequence.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/sequence-type|4.0.0'}},
    ...
    class ReferenceSeq < FHIR::Model
      ...
      METADATA = {
        ...
        'orientation' => {'type'=>'code', 'path'=>'ReferenceSeq.orientation', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/orientation-type|4.0.0'}},
        ...
        'strand' => {'type'=>'code', 'path'=>'ReferenceSeq.strand', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/strand-type|4.0.0'}},
    ...
    class Quality < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Quality.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/quality-type|4.0.0'}},
    ...
    class Repository < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Repository.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/repository-type|4.0.0'}},
    ...
    class StructureVariant < FHIR::Model
      ...
      METADATA = {
        ...
        'variantType' => {'type'=>'CodeableConcept', 'path'=>'StructureVariant.variantType', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://loinc.org/vs/LL379-9|4.0.0'}},
