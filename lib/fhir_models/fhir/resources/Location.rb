module FHIR
  class Location < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'Location.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/location-status|4.0.0'}},
      ...
      'mode' => {'type'=>'code', 'path'=>'Location.mode', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/location-mode|4.0.0'}},
    ...
    class HoursOfOperation < FHIR::Model
      ...
      METADATA = {
        ...
        'daysOfWeek' => {'type'=>'code', 'path'=>'HoursOfOperation.daysOfWeek', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/days-of-week|4.0.0'}},
