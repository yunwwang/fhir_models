module FHIR
  class Location < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'Location.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'status' => {'type'=>'code', 'path'=>'Location.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/location-status|4.0.0', 'uri'=>nil}},
      'operationalStatus' => {'type'=>'Coding', 'path'=>'Location.operationalStatus', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://terminology.hl7.org/ValueSet/v2-0116', 'uri'=>nil}},
      ...
      'mode' => {'type'=>'code', 'path'=>'Location.mode', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/location-mode|4.0.0', 'uri'=>nil}},
      'type' => {'type'=>'CodeableConcept', 'path'=>'Location.type', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'valueSet'=>'http://terminology.hl7.org/ValueSet/v3-ServiceDeliveryLocationRoleType', 'uri'=>nil}},
    ...
    class HoursOfOperation < FHIR::Model
      ...
      METADATA = {
        ...
        'daysOfWeek' => {'type'=>'code', 'path'=>'HoursOfOperation.daysOfWeek', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/days-of-week|4.0.0', 'uri'=>nil}},
