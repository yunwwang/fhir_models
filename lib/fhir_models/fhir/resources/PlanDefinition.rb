    ...
    class Action < FHIR::Model
      ...
      class Participant < FHIR::Model
        ...
        METADATA = {
          ...
          'type' => {'type'=>'code', 'path'=>'Participant.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/action-participant-type|4.0.0'}},
