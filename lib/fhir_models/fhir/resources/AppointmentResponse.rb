module FHIR
  class AppointmentResponse < FHIR::Model
    ...
    METADATA = {
      ...
      'participantStatus' => {'type'=>'code', 'path'=>'AppointmentResponse.participantStatus', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/participationstatus|4.0.0'}},
