module FHIR
  class RiskEvidenceSynthesis < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'RiskEvidenceSynthesis.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0'}},
    ...
    class RiskEstimate < FHIR::Model
      ...
      METADATA = {
        ...
        'unitOfMeasure' => {'type'=>'CodeableConcept', 'path'=>'RiskEstimate.unitOfMeasure', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/ucum-units|4.0.0'}},
