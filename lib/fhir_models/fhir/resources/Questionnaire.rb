  ...
  class Questionnaire < FHIR::Model
    ...
    class Item < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/item-type'=>['group', 'display', 'boolean', 'decimal', 'integer', 'date', 'dateTime', 'time', 'string', 'text', 'url', 'choice', 'open-choice', 'attachment', 'reference', 'quantity']}, 'type'=>'code', 'path'=>'Item.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/item-type|4.0.0'}},
