module FHIR
  class Questionnaire < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'Questionnaire.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0'}},
      'experimental' => {'type'=>'boolean', 'path'=>'Questionnaire.experimental', 'min'=>0, 'max'=>1},
      'subjectType' => {'type'=>'code', 'path'=>'Questionnaire.subjectType', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/resource-types|4.0.0'}},
    ...
    class Item < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Item.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/item-type|4.0.0'}},
        'enableWhen' => {'type'=>'Questionnaire::Item::EnableWhen', 'path'=>'Item.enableWhen', 'min'=>0, 'max'=>Float::INFINITY},
        'enableBehavior' => {'type'=>'code', 'path'=>'Item.enableBehavior', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/questionnaire-enable-behavior|4.0.0'}},
      ...
      class EnableWhen < FHIR::Model
        ...
        METADATA = {
          ...
          'operator' => {'type'=>'code', 'path'=>'EnableWhen.operator', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/questionnaire-enable-operator|4.0.0'}},
