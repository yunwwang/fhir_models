module FHIR
  class TerminologyCapabilities < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'type'=>'code', 'path'=>'TerminologyCapabilities.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0'}},
      ...
      'codeSearch' => {'valid_codes'=>{'http://hl7.org/fhir/code-search-support'=>['explicit', 'all']}, 'type'=>'code', 'path'=>'TerminologyCapabilities.codeSearch', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/code-search-support|4.0.0'}},
