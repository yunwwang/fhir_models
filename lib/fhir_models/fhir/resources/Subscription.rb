module FHIR
  class Subscription < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'type'=>'code', 'path'=>'Subscription.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/subscription-status|4.0.0'}},
    ...
    class Channel < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'type'=>'code', 'path'=>'Channel.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/subscription-channel-type|4.0.0'}},
