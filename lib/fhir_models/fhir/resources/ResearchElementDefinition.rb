module FHIR
  class ResearchElementDefinition < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'ResearchElementDefinition.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages', 'uri'=>nil}},
      ...
      'status' => {'type'=>'code', 'path'=>'ResearchElementDefinition.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/publication-status|4.0.0', 'uri'=>nil}},
      'experimental' => {'type'=>'boolean', 'path'=>'ResearchElementDefinition.experimental', 'min'=>0, 'max'=>1},
      'subjectCodeableConcept' => {'type'=>'CodeableConcept', 'path'=>'ResearchElementDefinition.subject[x]', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'valueSet'=>'http://hl7.org/fhir/ValueSet/subject-type', 'uri'=>nil}},
      ...
      'jurisdiction' => {'type'=>'CodeableConcept', 'path'=>'ResearchElementDefinition.jurisdiction', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'valueSet'=>'http://hl7.org/fhir/ValueSet/jurisdiction', 'uri'=>nil}},
      ...
      'topic' => {'type'=>'CodeableConcept', 'path'=>'ResearchElementDefinition.topic', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'valueSet'=>'http://hl7.org/fhir/ValueSet/definition-topic', 'uri'=>nil}},
      ...
      'type' => {'type'=>'code', 'path'=>'ResearchElementDefinition.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/research-element-type|4.0.0', 'uri'=>nil}},
      'variableType' => {'type'=>'code', 'path'=>'ResearchElementDefinition.variableType', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/variable-type|4.0.0', 'uri'=>nil}},
    ...
    class Characteristic < FHIR::Model
      ...
      METADATA = {
        ...
        'unitOfMeasure' => {'type'=>'CodeableConcept', 'path'=>'Characteristic.unitOfMeasure', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/ucum-units|4.0.0', 'uri'=>nil}},
        ...
        'studyEffectiveGroupMeasure' => {'type'=>'code', 'path'=>'Characteristic.studyEffectiveGroupMeasure', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/group-measure|4.0.0', 'uri'=>nil}},
        ...
        'participantEffectiveGroupMeasure' => {'type'=>'code', 'path'=>'Characteristic.participantEffectiveGroupMeasure', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'valueSet'=>'http://hl7.org/fhir/ValueSet/group-measure|4.0.0', 'uri'=>nil}}
      }
